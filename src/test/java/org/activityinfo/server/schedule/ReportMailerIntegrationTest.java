...
public class ReportMailerIntegrationTest {
    ...
    public void test() throws IOException, SAXException, JAXBException {
        ...
        // Persistence.createEntityManagerFactory("activityInfo");
        ...
        // PivotChartGenerator pcgen = new PivotChartGenerator(pivotDAO,
        // schemaDAO);
        // MapGenerator mgen = new MapGenerator(pivotDAO, siteTableDAO,
        // baseMapDAO);
        // TableGenerator tgen = new TableGenerator(pivotDAO, siteTableDAO,
        // schemaDAO, mgen);
        //
        // ReportGenerator rgen = new ReportGenerator(pivotDAO, ptgen, pcgen,
        // tgen, mgen);
        //
        // RtfReportRenderer rtfren = new RtfReportRenderer(new
        // ItextPivotTableRenderer(),
        // new ItextChartRenderer(new ChartRendererJC()), new
        // ItextMapRenderer("war/mapicons"),
        // new ItextTableRenderer(new ItextMapRenderer("war/mapicons")));
        //
        // ReportMailerJob job = new ReportMailerJob(em, rgen, rtfren, new
        // MailerImpl() );
        //
        //
        ...
        //
        // List<ReportDefinition> templates =
        // em.createQuery("select t from ReportDefinition t").getResultList();
        //
