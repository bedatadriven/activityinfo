...
public class DesignTest {
    ...
    public void testSave() {
        ...
        ActivityModel activity = (ActivityModel) ((TreeStore)designer.getStore()).getRootItems().get(0);
    ...
    public void testNewActivityComesWithFolders() {
        ...
        ActivityModel addedActivity = (ActivityModel) rootItems.get(rootItems.size() - 1);
