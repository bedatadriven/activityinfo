package org.activityinfo.shared.db;
...
public class Tables {
	...
	public static final String ATTRIBUTE_GROUP_IN_ACTIVITY =  "attributegroupinactivity";
	public static final String ATTRIBUTE_VALUE =  "attributevalue";
	public static final String AUTHENTICATION =  "authentication";
	public static final String BASEMAP =  "basemap";
	public static final String COUNTRY =  "country";
	public static final String INDICATOR =  "indicator";
	public static final String INDICATOR_LINK =  "indicatorlink";
	public static final String INDICATOR_VALUE =  "indicatorvalue";
	public static final String LOCATION =  "location";
	public static final String LOCATION_ADMIN_LINK =  "locationadminlink";
	public static final String LOCATION_TYPE =  "locationtype";
	public static final String LOCKED_PERIOD =  "lockedperiod";
	public static final String PARTNER =  "partner";
	public static final String PARTNER_IN_DATABASE =  "partnerindatabase";
	public static final String PROJECT =  "project";
	public static final String REPORTING_PERIOD =  "reportingperiod";
	public static final String REPORT_SUBSCRIPTION =  "reportsubscription";
