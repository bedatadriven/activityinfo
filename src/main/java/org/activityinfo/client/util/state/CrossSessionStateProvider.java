 ...
 * 
 * The normal StateProvider may not persist session on browsers that do not
 * support local storage. Class should qualify dependencies with this interface
 * if they absolutely require persistence of state across sessions.
 */
