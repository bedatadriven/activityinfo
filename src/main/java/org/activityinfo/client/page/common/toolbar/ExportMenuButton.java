...
/**
 * SplitButton that provides users with a choice to export in a number of
 * formats.
 */
public class ExportMenuButton extends SplitButton {
    ...
    /**
     * @param defaultFormat
     *            the default format that should appear on the SplitButton
     * @param callback
     *            the object to call back upon selection
     */
