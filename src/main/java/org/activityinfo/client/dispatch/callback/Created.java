...
public abstract class Created implements AsyncCallback<CreateResult> {
     ...
     * <p/>
     * The provided {@link AsyncMonitor} should take care of any UI stuff that
     * needs to happen; you probably only need to provide a substantive
     * implementation here if something needs to be rolled back.
     */
    @Override
