...
/**
 * Executes {@link org.activityinfo.shared.command.Command}s on behalf of client
...
public interface Dispatcher {
     ...
     * @param monitor
     *            The monitor which handles status reports to the user
     * @param callback
     *            The callback which implements application logic
     * @param <T>
     *            The Command subclass
     */
