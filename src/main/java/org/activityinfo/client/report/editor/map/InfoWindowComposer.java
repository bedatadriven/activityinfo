...
public class InfoWindowComposer {
    ...
    // content.getIndicatorById(slice.getIndicatorId());
    //
    // builder.append("<li>")
    ...
    //
    //
    // private void addClusteringMessage(BubbleMapMarker marker, StringBuilder
    // builder) {
    // builder.append("<p>");
    // if (marker.getClustering() instanceof NoClustering) {
    // builder.append(I18N.CONSTANTS.none() + " " +
    // I18N.CONSTANTS.clustering());
    //
    ...
    //
    // } else if (marker.getClustering() instanceof
    // AdministrativeLevelClustering) {
    // AdministrativeLevelClustering admincl = (AdministrativeLevelClustering)
    // marker.getClustering();
    // AdminLevelDTO adminLevel =
    // schema.getAdminLevelById(admincl.getAdminLevels().get(0));
    //
    // builder.append(I18N.MESSAGES.amountSitesClusteredByClusteringMethod(
    // Integer.toString(marker.getClusterAmount()),
