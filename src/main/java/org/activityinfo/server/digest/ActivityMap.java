...
public class ActivityMap {
     ...
     * @param date
     * @param days
     *            amount of days, base 1, so if we're only looking for today, the days parameter has a value of 1. The
     *            activitymap always has one more entry to accomodate the period between the last digest and midnight of
     *            that day.
     * @param histories
     */
