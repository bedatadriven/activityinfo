...
public class MessageBuilder {
    ...
    public MessageBuilder to(String email, String name)
    ...
    public MessageBuilder replyTo(String email, String name)
        throws MessagingException {
        Address address;
        try {
    ...
    public class PartBuilder {
        ...
        public PartBuilder withFileName(String filename)
            throws MessagingException {
            attachment.setFileName(filename);
            return this;
        }

        public PartBuilder withContent(byte[] content, String mimeType)
            throws MessagingException {
