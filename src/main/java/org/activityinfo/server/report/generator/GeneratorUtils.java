...
public class GeneratorUtils {
     ...
     * {@link org.activityinfo.shared.report.model.ReportElement#getFilter()}
     * 
     * @param element
     *            The report element for which to resolve the filter
     * @param inheritedFilter
     *            The <code>Filter</code> that is inherited from the enclosing
     *            <code>Report</code> or other container
     * @param dateRange
     *            The overall <code>DateRange</code> of the report. This may be
