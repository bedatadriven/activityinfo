 ...
 * 
 * @param <T>
 *            The type of <code>ReportElement</code> accepted by the
...
public interface ContentGenerator<T extends ReportElement> {
     ...
     * 
     * @param user
     *            The user for whom this content is generated. Effects such
     *            things as locale and access restrictions.
     * @param element
     *            The definition of the element for which to generate content
     * @param inheritedFilter
     *            Any filter inherited from an enclosing report or other
     *            container that should be intersected with the elements
     *            <code>Filter</code> to obtain the effective filter.
     * @param range
     *            The overall <code>DateRange</code> for the <code>Report</code>
