...
//        Assert.assertEquals(9, ub.get(1));
    ...
    public void testComplexCluster() throws Exception {
        ...
        Assert.assertEquals("originalSum==sumAfterMerging", data.originalSum, sumAfterMerging);
        ...
        while(count-- > 0) {
            ...
            Assert.assertEquals("originalSum==sumAfterClustering", data.originalSum, sumAfterClustering);
