 ...
 * 	'C:/Users/Owner/Eclipse/activityinfo/war/WEB-INF/classes/org/activityinfo/shared/i18n/UIConstants.properties'.
 */
public interface UIConstants extends com.google.gwt.i18n.client.Constants {
  ...
  /**
   * Translated "Go offline".
   * 
   * @return translated "Go offline"
   */
  @DefaultStringValue("Go offline")
  @Key("goOffline")
  String goOffline();
  ...
  /**
   * Translated "Load failed due to error on the server; please report this to Alex.".
   * 
   * @return translated "Load failed due to error on the server; please report this to Alex."
   */
  @DefaultStringValue("Load failed due to error on the server; please report this to Alex.")
  @Key("serverError")
  String serverError();
