...
public class IconFactory {
	...
	public Icon createMarkerIcon() {
		...
		icon.setImageMap( new int[] {
				...
				(int)((1d / 2d) * width), 0,
				(int)((11d / 16d) * width), (int)((1 / 8) * height),
				(int)((25d / 32d) * width), (int)((5 / 16) * height),
				(int)((11d / 16d) * width), (int)((7 / 16) * height),
				(int)((9d / 16d) * width), (int)((5 / 8) * height) });
    ...
    public Icon createIcon(MapIcon mapIcon) {
    ...
    public Icon createBubble(int color, int radius) {
