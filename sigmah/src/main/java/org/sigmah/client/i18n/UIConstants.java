...
public interface UIConstants extends com.google.gwt.i18n.client.Constants {
   ...
   */
  @DefaultStringValue("Add layer...")
  @Key("addLayerWithDialogHint")
  String addLayerWithDialogHint();
  ...
  /**
   * Translated "User creation".
   * 
   * @return translated "User creation"
   */
  @DefaultStringValue("User creation")
  ...
  @Key("adminUserCreationChoiceProblem")
  String adminUserCreationChoiceProblem();
  ...
  /**
   * Translated "Users administration".
   * 
   * @return translated "Users administration"
   */
  @DefaultStringValue("Users administration")
  @Key("adminUsers")
  String adminUsers();
  ...
  /**
   * Translated "Attributs".
   * 
   * @return translated "Attributs"
   */
  @DefaultStringValue("Attributs")
  @Key("attributs")
  String attributs();
  ...
  /**
   * Translated "Back to List".
   * 
   * @return translated "Back to List"
   */
  ...
  @Key("createProjectFormIncomplete")
  String createProjectFormIncomplete();

  /**
   * Translated "Please fill all the required fields to create a project.".
   * 
   * @return translated "Please fill all the required fields to create a project."
   */
  @DefaultStringValue("Please fill all the required fields to create a project.")
  @Key("createProjectFormIncompleteDetails")
  String createProjectFormIncompleteDetails();
  ...
  /**
   * Translated "No basemaps present in the database".
   * 
   * @return translated "No basemaps present in the database"
   */
  @DefaultStringValue("No basemaps present in the database")
  @Key("failBaseMapLoadingCount")
  String failBaseMapLoadingCount();
  ...
  @Key("flexibleElementDateFormat")
  String flexibleElementDateFormat();
  ...
  /**
   * Translated "The file is too big (max 20Mb).".
   * 
   * @return translated "The file is too big (max 20Mb)."
   */
  @DefaultStringValue("The file is too big (max 20Mb).")
  ...
  /**
   * Translated "MM/dd/yyyy - HH:mm:ss".
   * 
   * @return translated "MM/dd/yyyy - HH:mm:ss"
   */
  @DefaultStringValue("MM/dd/yyyy - HH:mm:ss")
  @Key("historyDateFormat")
   ...
   * 
   * @return translated "Assumptions"
   */
  @DefaultStringValue("Assumptions")
  @Key("logFrameAssumptions")
  String logFrameAssumptions();
  ...
  /**
   * Translated "Indicators and Means of verification".
   * 
   * @return translated "Indicators and Means of verification"
   */
  @DefaultStringValue("Indicators and Means of verification")
  @Key("logFrameIndicators")
  String logFrameIndicators();
   ...
   * Translated "Risks".
   * 
   * @return translated "Risks"
   */
  @DefaultStringValue("Risks")
  @Key("logFrameRisks")
  String logFrameRisks();
  ...
  /**
   * Translated "Did you forgot your password?".
   * 
   * @return translated "Did you forgot your password?"
   */
  @DefaultStringValue("Did you forgot your password?")
   ...
   */
  @DefaultStringValue("MM/dd/yyyy")
  @Key("monitoredPointDateFormat")
  String monitoredPointDateFormat();
  ...
  /**
   * Translated "The points have been correctly modified.".
   * 
   * @return translated "The points have been correctly modified."
   */
  @DefaultStringValue("The points have been correctly modified.")
  ...
  /**
   * Translated "An error occurred during the modification of the points.".
   * 
   * @return translated "An error occurred during the modification of the points."
   */
  @DefaultStringValue("An error occurred during the modification of the points.")
  ...
  /**
   * Translated "Financial projects".
   * 
   * @return translated "Financial projects"
   */
  @DefaultStringValue("Financial projects")
  ...
  /**
   * Translated "Local partner projects".
   * 
   * @return translated "Local partner projects"
   */
  @DefaultStringValue("Local partner projects")
  ...
  /**
   * Translated "This project is now tagged as favorite.".
   * 
   * @return translated "This project is now tagged as favorite."
   */
  @DefaultStringValue("This project is now tagged as favorite.")
  @Key("projectStarred")
  ...
  /**
   * Translated "The todos have been correctly modified.".
   * 
   * @return translated "The todos have been correctly modified."
   */
  @DefaultStringValue("The todos have been correctly modified.")
  @Key("reminderUpdateConfirm")
  String reminderUpdateConfirm();

  /**
   * Translated "An error occurred during the modification of the todos.".
   * 
   * @return translated "An error occurred during the modification of the todos."
   */
  @DefaultStringValue("An error occurred during the modification of the todos.")
  ...
  /**
   * Translated "Selected layers".
   * 
   * @return translated "Selected layers"
   */
  ...
  /**
   * Translated "Tyep of layer".
   * 
   * @return translated "Tyep of layer"
   */
  @DefaultStringValue("Tyep of layer")
  @Key("typeOfLayer")
  String typeOfLayer();
