 ...
 * @author Alex Bertram
 */
public class SigmahReportLoader implements PageLoader {

    private final SigmahInjector injector;
    private final Dispatcher service;

    @Inject
    public SigmahReportLoader(SigmahInjector injector, Dispatcher service, NavigationHandler pageManager,
