 ...
 */
public class SigmahDataEntryLoader implements PageLoader {

    private final SigmahInjector injector;

    @Inject
    public SigmahDataEntryLoader(SigmahInjector injector, NavigationHandler pageManager, PageStateSerializer placeSerializer) {
