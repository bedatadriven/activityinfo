...
public abstract class ItextChartRenderer implements ItextRenderer<PivotChartElement>{
	...
	protected abstract void renderImage(DocWriter writer, Document doc, PivotChartElement element, float width, float height)
		throws Exception;
}
