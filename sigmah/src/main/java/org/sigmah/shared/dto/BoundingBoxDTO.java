...
public final class BoundingBoxDTO implements Serializable  {
    ...
    /**
     *
     * @param x1  Minimum x value (most westernly longitude)
     * @param y1  Minimum y value (most southernly latitude)
     * @param x2  Maximum x value (most easternly longitude)
     * @param y2  Maximum y value (most northernly latitude)
     */
     ...
     *
     * @param bounds the instance to copy
     */
     ...
     * BoundingBoxDTO
     *
     * @param b another BoundingBoxDTO with which to intersect this BoundingBoxDTO
     ...
     *
     * If <code>x</code> is between [x1, x2], return x
     * If <code>x</code> is less than x1, return x1
     * If <code>x</code> is greater than y1, return y1
     *
     * @param x
