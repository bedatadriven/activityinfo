...
/**
 *
 * Partial DTO of the {@link org.sigmah.server.database.hibernate.entity.Site Site} domain object and its
 * {@link org.sigmah.server.database.hibernate.entity.Location Location} location that includes only
