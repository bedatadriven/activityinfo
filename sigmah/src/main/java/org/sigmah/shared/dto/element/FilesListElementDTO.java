...
public class FilesListElementDTO extends FlexibleElementDTO {
    ...
    /**
     * The store to manage monitored points generated by this element.
     */
    private transient ListStore<MonitoredPointDTO> monitoredPointsStore;
    ...
    public void setMonitoredPointsStore(ListStore<MonitoredPointDTO> monitoredPointsStore) {
        this.monitoredPointsStore = monitoredPointsStore;
    }
    ...
    private void updateComponentAfterUpload(FormEvent be) {
        ...
        if (FileUploadUtils.isError(code)) {
            ...
            if (monitoredPointGenerated && monitoredPointsStore != null) {
                ...
                if (point != null) {
                    ...
                    monitoredPointsStore.add(point);
                }
